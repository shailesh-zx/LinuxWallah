document.addEventListener("DOMContentLoaded", function () {
    ...
    if (userData) {
        try {
            ...
            // Sahi name aur email extract karo fallback ke sath
            let realName = user.username || user.name || user.user || "Student";
            let realEmail = user.email || "No Email";
            
            // 🔥 BULLETPROOF CHECK: Agar browser me "undefined" text save ho gaya ho toh block karo
            if (realName === "undefined") realName = "Hacker";
            if (realEmail === "undefined") realEmail = "hidden@email.com";
            ...
            style.innerHTML = `
                ...
                .nav-user-img { width: 38px; height: 38px; border-radius: 50%; border: 2px solid #0860bb; object-fit: cover; background: #222; }
            ...
            // Replace Login Button with Only Circle Image
            ...
            console.error("Local storage data corrupt, clearing it...");
            localStorage.removeItem("user");
        }
    }
});
