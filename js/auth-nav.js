document.addEventListener("DOMContentLoaded", function () {
    ...
    // Backend se aane wale alag-alag possible names ko check kar rahe hain taaki 'undefined' na aaye
    let oauthUser = urlParams.get('name') || urlParams.get('user') || urlParams.get('username');
    let oauthEmail = urlParams.get('email');
    
    // 1. Agar Social Login se data aaya hai to save karo
    if (oauthUser && oauthUser !== "undefined") {
        
        // 👉 Random 4-character string generate karo (numbers + letters)
        ...
        // URL saaf karo taaki bar-bar reload pe same data process na ho
